          ...
          <div class="card-body">
            <form method="GET" action="{{route('search.searchAlkes')}}">
              ...
              <div class="form-group">
                <input type="text" name="nama_alkes" class="form-control rounded-pill border-primary" id="nama_alkes"
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md">
                  ...
                  <select id="kabupaten_id" name="kabupaten_id" class="form-control rounded-pill border-info">
