  ...
  <div class="container">
    <div class="row">
      <div class="col-lg">
        <div class="card mt-3">
          <div class="card-body">
            <form action="{{route('search.searchObat')}}" method="GET">
              <h3 class="text-center text-info"><b>Cari Obat</b></h3>
              <div class="form-group">
                <input type="text" class="form-control rounded-pill border-primary" id="nama_obat" name="nama_obat"
