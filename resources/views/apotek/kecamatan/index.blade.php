        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Kecamanatan</h3>

              <div class="card-tools">
                <button class="btn btn-info" data-toggle="modal" data-target="#addProvince">Tambah Kecamatan</button>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body table-responsive p-0">
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ ++$key }}</td>
                    <td>{{ ucwords($district['nama_kecamatan']) }}</td>
                    <td>{{ ucwords($district->cities['nama_kabupaten_kota'])}}</td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
        ...
        <div class="modal-body">
          <div class="input-group mb-3">
            <input type="text" id="nama_kecamatan" name="nama_kecamatan"
              class="form-control @error('nama_kecamatan') is-invalid @enderror" placeholder="Kecamatan"
          ...
          <div class="input-group mb-3">
            <select class="form-control" name="kabupaten_id" id="kabupaten_id">
              ...
              <option value="{{$city['id']}}">{{ $city['nama_kabupaten_kota'] }}</option>
              @endforeach
            </select>
          </div>
        </div>
